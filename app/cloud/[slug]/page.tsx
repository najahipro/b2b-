    ...
    <div className="pt-32 pb-16 lg:pt-40 lg:pb-0">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
           <div className="bg-card border border-border p-8 rounded-3xl shadow-sm">
              <h3 className="text-xl font-bold mb-3">Live Migration</h3>
              <p className="text-muted-foreground">We move your entire infrastructure layer by layer while ensuring the application stays live with absolutely zero downtime for your users.</p>
           </div>
           <div className="bg-card border border-border p-8 rounded-3xl shadow-sm">
              <h3 className="text-xl font-bold mb-3">Continuous Sync</h3>
              <p className="text-muted-foreground">Databases are synchronized in real time across the old and new clusters to ensure no transaction data is lost during the switchover.</p>
           </div>
           <div className="bg-card border border-border p-8 rounded-3xl shadow-sm">
              <h3 className="text-xl font-bold mb-3">Instant Rollback</h3>
              <p className="text-muted-foreground">Automated health checks monitor the migration. In the unlikely event of an error, the system rolls back instantly to the previous state without manual intervention.</p>
           </div>
        </div>
      </div>
    </div>
